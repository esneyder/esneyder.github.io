    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Favoritos
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                    ...
                    <div class="col-lg-6">
                        <div class="panel panel-blue">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-pencil fa-fw"></i> Mantenimiento Favoritos</h3>
                            </div>
                            <div class="panel-body">
                                <p></p>
                                <label><a href="newFavorite.php" class="btn btn-primary"><span class="fa fa-plus-square"></span> Nuevo Favorito</a></label>
                                <label><a href="detail.php" class="btn btn-info"><span class="fa fa-list-alt"></span> Ver Detalles</a></label>
                            </div>
                        </div>                        
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-pink">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-star fa-fw"></i> Lista de Favoritos</h3>
                            </div>
                            <div class="panel-body">
                                <?php
                                    error_reporting(0);
